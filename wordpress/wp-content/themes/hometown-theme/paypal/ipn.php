...
$paypal_merchant_id = nt_get_option('property', 'paypal_merchant_id');
$enable_sandbox     = (nt_get_option('property', 'paypal_server', 'sandbox') == 'sandbox') ? true : false;
$valid_ipn_email    = get_bloginfo('admin_email');
$invalid_ipn_email  = get_bloginfo('admin_email');
